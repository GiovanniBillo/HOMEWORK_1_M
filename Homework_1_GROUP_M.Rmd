...
- La popolazione totale è di \( N = 200 \)
- La dimensione campionaria è \( n = 624 \)
- La proporzione campionaria osservata è \( \hat{p} = 0.52 \) (ovvero 52%)
...
Utilizziamo un test z per confrontare la proporzione campionaria con la proporzione ipotizzata. Calcoliamo quindi il valore di z e il p-value.
...
>>>>>>> 934a9c40d2be50cb12920e5549347502c093efa2
